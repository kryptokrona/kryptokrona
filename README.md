...
| Munin | [1.1.0[(https://github.com/kryptokrona/kryptokrona/releases/tag/1.1.0)   | Yes       | Refactoring whole core, improving CI/CD for automate build of target on push to master and changed target names.                                                                         |
