...
namespace cryptonote
{
    ...
    public:
      WalletGreen(sys::Dispatcher& dispatcher, const Currency& currency, INode& node, std::shared_ptr<logging::ILogger> logger, uint32_t transactionSoftLockTime = 1);
      virtual ~WalletGreen();
    ...
    #pragma pack(pop)
      ...
      mutable sys::Event m_readyEvent;
